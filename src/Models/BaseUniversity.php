...
class BaseUniversity extends Model
{
    use ValidatingTrait;
    ...
    {
        $this->setTable(config('rinvex.universities.tables.universities'));
        $this->mergeRules([
    ...
    public function cache(?int $duration = null): self
    {
        ...
        $cacheDuration = $duration ?? config('cortex_universities.cache_duration');
